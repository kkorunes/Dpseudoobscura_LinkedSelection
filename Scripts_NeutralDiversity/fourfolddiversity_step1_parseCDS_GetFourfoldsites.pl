...
#
#  Step 1 in the pipeline to collect and analyze 4-fold degenerate sites. 
#  This script finds the positions of the CDSs from the FlyBase fasta 
#  (already separated by chromosome).
#
