...
do
	...
	/datacommons/noor/klk37/java/jdk1.8.0_144/bin/java -Xmx8G -jar /datacommons/noor/klk37/picard.jar SamToFastq \
		...
		TMP_DIR=`pwd`/tmp | \
		/opt/apps/rhel7/bwa-0.7.17/bwa mem -M -t 4 -p /datacommons/noor2/klk37/BackgroundSelection/dpse-all-chromosome-r3.04.fasta /dev/stdin | \
		...
		R=/datacommons/noor2/klk37/BackgroundSelection/dpse-all-chromosome-r3.04.fasta CREATE_INDEX=true ADD_MATE_CIGAR=true \
